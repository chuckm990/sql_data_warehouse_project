...
BEGIN
	...
	BEGIN TRY
		...
		-- *** TABLE 3: silver.crm_sales_information
		SET @start_time = GETDATE();
		...
		SELECT
			CASE WHEN cid LIKE ('NAS%') THEN SUBSTRING(cid, 4, LEN(cid))
				ELSE cid
			END AS cid,
			CASE WHEN bdate < '1904-01-01' OR bdate > GETDATE() THEN NULL
				ELSE bdate
			END AS bdate,
